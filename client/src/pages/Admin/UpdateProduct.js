...
const UpdateProduct = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const { data } = axios.put(`https://backend-adkt.onrender.com/api/v1/product/update-product/${id}`, productData)
            if (data?.success) {
    ...
    const handleDelete = async() => {
        try {
            ...
            if(!answer) return;
            const {data} = await axios.delete(`https://backend-adkt.onrender.com/api/v1/product/delete-product/${id}`)
                        ...
                        <div className='m-1 w-75'>
                            ...
                            <div className='mb-3'>
                                {photo ? (
                                    ...
                                    <div className='text-center'>
                                    <img src={`https://backend-adkt.onrender.com/api/v1/product/product-photo/${id}`} alt='product_photo' height={'200px'} className='img img-responsive' />
                                </div>
                                )}
                            </div>
                            <div className='mb-3'>
